...
export function DataImport() {
  ...
  async function downloadTemplate() {
    ...
    const person = [
      PERSON_HEADERS,
      ['C001', '示例合格', 'A-EQ-ELEC', '电气检修班', '电气检修技术员', '主岗', '2024-01-01', '', '在职'],
      ['C002', '非标岗位', 'A-EQ-ELEC', '电气检修班', '电修技术员', '主岗', '2023-05-01', '', '在职'],
      ['', '缺工号', 'A-EQ-ELEC', '电气检修班', '电气检修技术员', '主岗', '2024-01-01', '', '在职'],
      ['C003', '非法岗位', 'A-EQ-ELEC', '电气检修班', '12345', '主岗', '2024-01-01', '', '在职'],
      ['C004', '日期错误', 'A-EQ-ELEC', '电气检修班', '电气检修技术员', '主岗', '不是日期', '', '在职'],
      ['C005', '结束早于开始', 'A-EQ-ELEC', '电气检修班', '电气检修技术员', '主岗', '2024-06-01', '2024-01-01', '在职'],
      ['C006', '疑似异常', 'A-BLR', '锅炉检修车间', '财务主管', '主岗', '2024-01-01', '', '在职'],
    ]
    const cert = [
      CERT_HEADERS,
